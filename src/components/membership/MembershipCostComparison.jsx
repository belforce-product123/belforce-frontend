...
function MembershipCostComparison() {
  return (
    <section className="membership-cost">
      <h2 className="membership-cost__heading">Cost Comparison</h2>
      ...
      <div className="membership-cost__card membership-cost__card--classified">
        ...
        <p className="membership-cost__card-desc">Traditional platforms often come with hidden costs and less value.</p>
        ...
        <p className="membership-cost__footer">Expect to pay per listing, with no guaranteed outcomes or support.</p>
      </div>
      ...
      <div className="membership-cost__card membership-cost__card--belforce">
        ...
        <p className="membership-cost__card-desc">Unlock maximum benefits and savings with our top-tier plan.</p>
        <div className="membership-cost__pricing">
