...
function MembershipCategoriesSection() {
  return (
    <section className="membership-categories">
      <h2 className="membership-categories__heading">More Categories Added Soon.</h2>
      <div className="membership-categories__grid">
        {CATEGORIES.map((cat) => (
          <button key={cat.id} type="button" className="membership-categories__btn">
            <span className="membership-categories__icon">
              <IconSvg type={cat.icon} />
            </span>
            <span className="membership-categories__label">{cat.label}</span>
          </button>
        ))}
      </div>
    </section>
